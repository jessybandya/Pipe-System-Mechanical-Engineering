...
function Final({ valueTotal,basementTotal,groundTotal,firstTotal,secondTotal,thirdTotal,fourthTotal,fifthTotal,pipeDevelopmentLength}) {
    ...
    const finalFun = () => {
        setModalShow(true)
        const bg = basementTotal + groundTotal + firstTotal + secondTotal + thirdTotal + fourthTotal + fifthTotal
        const gf1 = groundTotal + firstTotal + secondTotal + thirdTotal + fourthTotal + fifthTotal
        const f1f2 = firstTotal + secondTotal + thirdTotal + fourthTotal + fifthTotal
        const f2f3 = secondTotal + thirdTotal + fourthTotal + fifthTotal
        const f3f4 = thirdTotal + fourthTotal + fifthTotal
        const f4f5 = fourthTotal + fifthTotal
    ...
    const body = [
      ["B-G", bg.toFixed(2), sizeFun(bg,pipeDevelopmentLength)],
      ["G-F1", gf1.toFixed(2), sizeFun(gf1,pipeDevelopmentLength)],
      ["F1-F2", f1f2.toFixed(2), sizeFun(f1f2,pipeDevelopmentLength)],
      ["F2-F3", f2f3.toFixed(2), sizeFun(f2f3,pipeDevelopmentLength)],
      ["F3-F4", f3f4.toFixed(2), sizeFun(f3f4,pipeDevelopmentLength)],
      ["F4-F5", f4f5.toFixed(2), sizeFun(f4f5,pipeDevelopmentLength)],
    ];
