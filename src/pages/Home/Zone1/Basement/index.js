...
function Basement({setBasementTotal}) {
...
const calculateBasementTotal = () =>{
  ...
  setBasementTotal(parseFloat(total))
}     
...
/>
  ...
  <center>  <Button onClick={calculateBasementTotal} variant="contained" color="primary">Calculate</Button>
  </center>
  </>
  )
}
